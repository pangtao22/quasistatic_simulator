...
for i, duration in enumerate(durations):
    ...
    q_schunk_traj_list.append(
        PiecewisePolynomial.FirstOrderHold(
            ...
            np.array(
                [
                    [-schunk_setpoints[i], schunk_setpoints[i]],
                    [-schunk_setpoints[i + 1], schunk_setpoints[i + 1]],
                ]
            ).T,
        )
    )
...
q_u0_list[2] = [1, 0, 0, 0, 0.70, 0.0, 0.115]
q_u0_list[3] = [1, 0, 0, 0, 0.70, 0.0, 0.19]
